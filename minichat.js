...
function keyScheduleToHexStr(keySchedule) {  // return expanded key as hex words, as per FIPS-197Â§A
  var d = '';
...
function SelectCopy_onclick() 
{
    f.pt.focus();
    f.pt.select();
    window.clipboardData.setData('Text', f.pt.value);  
}
...
var timer=setInterval("refreshChat()", 0100); // répète toutes les 0,1s